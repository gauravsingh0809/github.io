  ...
  return (
    <div
      ...
      <Card>
        <DataTable
          title="Appendix 3.2
          Cases of incurring expenditure, which are not covered by the budget, but released by FD as addittionalities
          (Reference: Paragraph 3.6.2.1) ; 
          "
          
          columns={columns}
          data={ctx.tables1.Tablec2}
