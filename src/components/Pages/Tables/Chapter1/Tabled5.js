...
const columns = [
  ...
  },
  {
    ...
    selector: "Number of Institutions",
    sortable: true,
    
    
  },
  {
    name: "Years for which  information not received",
    selector: "Years for which  information not received",
    sortable: true,
    wrap:true,
    width:"250px",
