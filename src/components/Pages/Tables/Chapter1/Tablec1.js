...
const columns = [
  ...
  {
    name: "Child Centric Programme/Schemes",
    selector: "Child Centric Programme/Schemes",
    sortable: true,
    wrap:true,
  ...
  {
    name: "Child Centric Non Programme/Schemes",
    selector: "Child Centric Non Programme/Schemes",
    sortable: true,
    wrap:true,
...
const Tablec1 = () => {
  ...
  return (
    <div
      ...
      <Card>
        <DataTable
          title="Appendix 3.1 Category wise/department wise budget allocation/expenditure for Child Budget (Reference: Paragraph 3.4)"
          
          columns={columns}
          data={ctx.tables1.Tablec1}
