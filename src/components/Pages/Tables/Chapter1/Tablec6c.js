...
const columns = [
  ...
  {
    name: "Re-appropriation (>₹1 crore) (-)",
    selector: "Re-appropriation (>1 crore) (-)",
    sortable: true,
...
const Tablec6c = () => {
  ...
  return (
    <div
      ...
      <Card>
        <DataTable
          title="Injudicious re-appropriation"
          
          columns={columns}
          data={ctx.tables1.Tablec6c}
