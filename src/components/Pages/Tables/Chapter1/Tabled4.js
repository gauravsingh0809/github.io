...
const columns = [
  ...
  {
    name: "Undertaking",
    selector: "Undertaking",
    sortable: true,
    wrap:true,
    width:"350px",
  },
  {
    name: "Accounts finalized up to",
    selector: "Accounts finalized up to",
    sortable: true,
    
    
  },
  {
    name: "Investment as per the last accounts finalized",
    selector: "Investment as per the last accounts finalized",
    sortable: true,
    wrap:true,
    width:"250px",
