...
const columns = [
  ...
  {
    name: "Excess required to be regularised as commented in the AA/AR",
    selector: "Excess required to be regularised as commented in the AA/AR",
    sortable: true,
  ...
  return (
    <div
      ...
      <Card>
        <DataTable
          title="Appendix 3.14
          Excess Expenditure over Provision requiring regularization
          (Reference: Paragraph 3.6.2.6 ; 
           ) "
          
          columns={columns}
          data={ctx.tables1.Tablec14}
