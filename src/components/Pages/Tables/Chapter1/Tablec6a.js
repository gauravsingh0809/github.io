...
const columns = [
  ...
  {
    name: "Budget including supplementary",
    selector: "Budget including Supplementary",
    sortable: true,
  ...
  {
    name: "Re-approrpriation (> ₹3 crore)    (+)",
    selector: "Re-approrpriation (> ₹3 crore)    (+)",
    sortable: true,
...
const Tablec6a = () => {
  ...
  return (
    <div
      ...
      <Card>
        <DataTable
          title="Excessive re-appropriation resulting in savings"
          
          columns={columns}
          data={ctx.tables1.Tablec6a}
