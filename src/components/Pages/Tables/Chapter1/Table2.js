...
const columns = [
    ...
    },
    {
        ...
        // sortable: true,
        right: true,
        format: data => data["Actuals for the year 2019-20"].toLocaleString('en-IN',{ style: 'currency', currency: 'INR' }),
    },
    {
        ...
        // sortable: true,
        right: true,
        format: data => data["Budgetary provisions for the year 2020-21"].toLocaleString('en-IN', { style: 'currency', currency: 'INR' }),
    },
    {
        ...
        // sortable: true,
        right: true,
        format: data => data["Actuals for the year 2020-21"].toLocaleString('en-IN', { style: 'currency', currency: 'INR' }),
    },
    {
