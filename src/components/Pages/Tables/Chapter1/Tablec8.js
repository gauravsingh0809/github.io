...
const Tablec8 = () => {
  ...
  return (
    <div
      ...
      <Card>
        <DataTable
          title="Appendix 3.8 Grants/Appropriations with unspent provisions of ₹100 crore and above (Reference: Paragraph  3.6.2.5(a) ;
          )
          "
          
          columns={columns}
          data={ctx.tables1.Tablec8}
