...
const columns = [
  ...
  {
    name: "Percentage to total provision",
    selector: "Percentage to total provision",
    sortable: true,
  ...
  return (
    <div
      ...
      <Card>
        <DataTable
          title="Appendix 3.13
          Cases of surrender of funds in excess of ₹ five crore on 30 and 31 of March 2022
          (Reference: Paragraph 3.6.2.5(b) ; ) "
          
          columns={columns}
          data={ctx.tables1.Tablec13}
