...
const columns = [
  ...
  {
    name: "Savings for which reasons not furnished",
    selector: "Savings for which reasons not furnished",
    sortable: true,
  ...
  return (
    <div
      ...
      <Card>
        <DataTable
          title="Appendix 3.15
          Grant-wise details under which reasons for savings not intimated
           (Reference: Paragraph 3.6.3.1 ; ) "
          
          columns={columns}
          data={ctx.tables1.Tablec15}
