...
const columns = [
  ...
  {
    name: "ರಾಜ್ಯ ಸರ್ಕಾರದ ಹಣಕಾಸು ಲೆಕ್ಕಗಳ ವಿನ್ಯಾಸವು ಕೆಳಕಂಡಂತಿದೆ;",
    selector: "ರಾಜ್ಯ ಸರ್ಕಾರದ ಹಣಕಾಸು ಲೆಕ್ಕಗಳ ವಿನ್ಯಾಸವು ಕೆಳಕಂಡಂತಿದೆ;",
    sortable: true,
    wrap: true,
    ...
    <div
      ...
      <Card>
        <DataTable
          ...
          columns={columns}
          data={ctx.tables1.Tablekan3}
          title=" ಅನುಬಂಧ ೧.೨
          ಸರ್ಕಾರಿ ಲೆಕ್ಕಗಳ ಸ್ವರೂಪ
          (ಉಲ್ಲೇಖ : ಕಂಡಿಕೆ ೧.೪;)
