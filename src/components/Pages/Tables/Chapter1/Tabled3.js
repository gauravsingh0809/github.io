...
const columns = [
  ...
  {
    name: "Name of the Autonomous Body",
    selector: "Name of the Autonomous Body",
    sortable: true,
    wrap:true,
    width:"350px",
  },
  {
    name: "Section under DPC Act",
    selector: "Section under DPC Act",
    sortable: true,
    
  },
  {
    name: "Period of entrustment",
    selector: "Period of entrustment",
    sortable: true,
    wrap:true,
  ...
  {
    name: "Year up to which accounts rendered",
    selector: "Year up to which accounts rendered",
    sortable: true,
    
  },
  {
    name: "Year up to which audit report  issued",
    selector: "Year up to which audit report  issued",
    sortable: true,
    
  },
  {
    name: "Placement of audit reports before the Legislature",
    selector: "Placement of audit reports before the Legislature",
    sortable: true,
