...
const columns = [
  ...
  {
    name: "Amount of unspent provision",
    selector: "Amount of unspent provision",
    sortable: true,
  ...
  {
    name: "Amount not surrendered",
    selector: "Amount not surrendered",
    sortable: true,
