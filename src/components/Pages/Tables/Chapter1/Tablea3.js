...
const columns = [
  ...
  {
    name: "The Layout of Finance Accounts of the State Government is detailed below:",
    selector: "The Layout of Finance Accounts of the State Government is detailed below:",
    sortable: true,
    wrap: true,
