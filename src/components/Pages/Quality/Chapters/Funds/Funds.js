            ...
            ? (ctx.chapterFour
                ? <div >
                    ...
                    <div className="contentwrapper" id="home">
                        ...
                        <Para>
                            {ctx.chapterFour.Quality.Funds["para0"]}
                        </Para>
                        <Title>A. Observations relating to completeness of accounts</Title>
                        <Title status={ctx.isStatus.status1} id={1}>{ctx.chapterFour.Quality.Funds.title}</Title>
                        <Title status={ctx.isStatus.status1} id={1}>{ctx.chapterFour.Quality.Funds.para1}</Title>
                        {ctx.isStatus.status1
                            ? <div>
                                {['para2', 'para3', 'para4'].map((item, ind) =>
                                    <Para key={ind}>
                                        {ctx.chapterFour.Quality.Funds[item]}
                                    </Para>
                                )}
                            </div>
                            : ""}
